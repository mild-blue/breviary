...
def recommended_heparin(weight: float, target_aptt_low: float, target_aptt_high: float, current_aptt: float,
                        previous_aptt: float, solution_heparin_units: float,
                        solution_ml: float) -> HeparinRecommendation:
    return 0
