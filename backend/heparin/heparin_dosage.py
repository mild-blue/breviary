...
def _default_heparin_continuous_dosage(patient_weight: kilogram) -> float:
...
def _calculate_bolus(weight: kilogram, solution_heparin_units: float, solution_ml: milliliter, units_per_kg: float) -> float:
